...
export const allModels: ModelItem[] = [
  ...
  { id: 't5', name: 'Claude Haiku 4.5', slug: 'claude-haiku-4.5', provider: 'Anthropic', category: 'text', description: 'Быстрая модель с расширенным мышлением', cost: 0.5, hasVariants: true, supportsVision: true },
  ...
  {
    id: 't11', name: 'Gemini 3 Flash', slug: 'gemini-3-flash', provider: 'Google',
    category: 'text', description: 'Быстрая модель Google', cost: 0.1, supportsVision: true
  },
  {
    ...
    provider: 'DeepSeek',
    category: 'text',
    description: 'Быстрая, контекст 1M',
    cost: 0.1,
  ...
  },
  {
    ...
    provider: 'DeepSeek',
    category: 'text',
    description: 'Reasoning: математика, код',
    cost: 0.5,
    supportsVision: false,
  },
  ...
  { id: 'i3', name: 'Nano Banana 2', slug: 'nano-banana-2', provider: 'Community', category: 'image', description: 'Стандартная версия, 1K–4K', cost: 3.30, hasVariants: true },
    { id: 'i3b', name: 'Nano Banana 2 Lite', slug: 'nano-banana-2-lite', provider: 'Google', category: 'image', description: 'Быстрый генератор, 1K', cost: 1.8, hasVariants: false },
  ...
  { id: 'i5', name: 'Seedream 5.0 Lite', slug: 'seedream-5-lite', provider: 'ByteDance', category: 'image', description: 'Быстрый генератор Seedream', cost: 1.60 },
    { id: 'i5b', name: 'Seedream 5.0 Pro', slug: 'seedream-5-pro', provider: 'ByteDance', category: 'image', description: 'Фотореалистичный генератор, 1K/2K', cost: 3.2, hasVariants: true, supportsVision: true },
...
export const chatFeedData: ChatItem[] = [
  { id: 'c1', title: 'Написать бизнес-план', model: 'GPT-5.4', preview: 'Помоги составить бизнес-план для стартапа...', time: '14:32', date: 'today', iconKey: 'message', isFavorite: true },
  { id: 'c2', title: 'Логотип для приложения', model: 'Midjourney', preview: 'Минималистичный логотип в стиле...', time: '12:15', date: 'today', iconKey: 'image', isFavorite: false },
  { id: 'c3', title: 'Рекламный ролик', model: 'Sora 2', preview: 'Сгенерируй 10-секундный ролик...', time: '11:03', date: 'today', iconKey: 'video', isFavorite: false },
  { id: 'c4', title: 'Анализ кода на Python', model: 'Claude Sonnet 4.6', preview: 'Проверь этот код на ошибки и оптимизируй...', time: '09:45', date: 'today', iconKey: 'message', isFavorite: true },
  { id: 'c5', title: 'Джингл для подкаста', model: 'Suno V4', preview: 'Весёлая мелодия для интро подкаста...', time: '18:20', date: 'yesterday', iconKey: 'audio', isFavorite: false },
  { id: 'c6', title: 'Перевод документа', model: 'Gemini 3.1 Pro', preview: 'Переведи этот контракт с английского...', time: '16:55', date: 'yesterday', iconKey: 'message', isFavorite: false },
  { id: 'c7', title: 'Иллюстрация к статье', model: 'GPT-5 Image', preview: 'Нарисуй иллюстрацию для блога о...', time: '14:30', date: 'yesterday', iconKey: 'image', isFavorite: true },
  { id: 'c8', title: 'Презентация продукта', model: 'Claude Opus 4.6', preview: 'Подготовь слайды для презентации...', time: '10:12', date: 'yesterday', iconKey: 'message', isFavorite: false },
  { id: 'c9', title: 'Исследование рынка', model: 'Perplexity Sonar', preview: 'Найди данные по рынку EdTech в России...', time: '15:40', date: 'earlier', iconKey: 'message', isFavorite: false },
  { id: 'c10', title: 'Промо-видео', model: 'Runway Gen-3', preview: 'Создай короткое видео для Instagram...', time: '11:25', date: 'earlier', iconKey: 'video', isFavorite: true },
  { id: 'c11', title: 'Озвучка статьи', model: 'ElevenLabs TTS Turbo', preview: 'Озвучь этот текст мужским голосом...', time: '09:00', date: 'earlier', iconKey: 'audio', isFavorite: false },
  { id: 'c12', title: 'Дебаг REST API', model: 'DeepSeek V3.2', preview: 'Помоги разобраться почему эндпоинт...', time: '22:15', date: 'earlier', iconKey: 'message', isFavorite: false },
]
...
export const categoriesData: CategoryCardData[] = [
  { id: 'text', title: 'Текстовые ИИ', description: 'GPT-5.4, Claude, Gemini и другие', coverUrl: '/covers/text.webp', modelCount: allModels.filter((m) => m.category === 'text').length },
  { id: 'image', title: 'Генерация картинок', description: 'Midjourney, Flux, GPT Image и другие', coverUrl: '/covers/image.webp', modelCount: allModels.filter((m) => m.category === 'image').length },
  { id: 'video', title: 'Генерация видео', description: 'Sora, Kling, Runway, Veo и другие', coverUrl: '/covers/video.webp', modelCount: allModels.filter((m) => m.category === 'video').length },
  { id: 'audio', title: 'Генерация аудио', description: 'Suno, ElevenLabs TTS, Dialogue, STT', coverUrl: '/covers/audio.webp', modelCount: allModels.filter((m) => m.category === 'audio').length },
]