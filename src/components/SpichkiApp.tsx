 ...
 *
 * Включено: SMTP Timeweb настроен (no-reply@spichki-ai.net), письма о сбросе
 * пароля уходят. Флаг оставлен как рубильник — если почта отвалится,
 * ставим false, и форма скрывается, а бэкенд гасится своим
 * EMAIL_AUTH_ENABLED в .env. Менять надо обе стороны: фронт прячет форму,
 * бэкенд закрывает эндпоинты.
 */
          ...
          <div className="fixed inset-0 z-[101] flex items-center justify-center p-4">
            ...
            >
              ...
              {/* Вход по почте — только вне Telegram: внутри мини-приложения
                  ...
                  Управляется флагом EMAIL_AUTH_ENABLED вверху файла:
                  выключать его надо вместе с одноимённой переменной в .env
                  бэкенда, иначе эндпоинты останутся открытыми. */}
